...
from analysis_module.serializers import EntryExtractionSerializerLLM, ExtractionRequestTypeChoices
...
def entry_extraction(request: Request):
    serializer = EntryExtractionSerializerLLM(data=request.data)
    ...
    req_type = NLPRequest.FeaturesType.ENTRY_EXTRACTION_LLM
